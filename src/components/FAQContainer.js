    ...
    return (
        <div id="faq-container" style={props.style}>
            ...
            <div id='faq-sub-container'>
                ...
                <p>In these browswers, when you press the save button (<img className='button-img' src='img/save.png' alt='Save button'/>) the image file will automatically download into whatever folder you have set as your downloads folder. The file will be named 'Pixel Drawing.png'. For multiple files, a number will be added to the end of the file name to differentiate between drawings.</p>
                <h3>In Safari, Mobile Safari, and Mobile Chrome</h3>
                <p>In these browsers, when you press the save button (<img className='button-img' src='img/save.png' alt='Save button'/>), it will open the image in a new browswer window. From there you can save the image by touching the image (on mobile) or right clicking (on Desktop).</p>
