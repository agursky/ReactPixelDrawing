...
export default function AddRemoveWindow(props) {
    return (
        ...
        <div className='add-remove-row'>
            <div className='add-remove-container'><button type='button' onClick={props.addRemFunc[5]}><img src={addRow} alt='Add Row'/></button><span>Add<br/> Row</span></div>
            <div className='add-remove-container'><button type='button' onClick={props.addRemFunc[4]}><img src={addCol} alt='Add Column'/></button><span>Add<br/>  Column</span></div>
        </div>
        <div className='add-remove-row'>
